...
//         ),
//       ),
//       body: context.select<WeatherService, bool>((value) => value.loading)
//           ? const LoadingWidget()
//           : Column(
...
//                       dimension: 8,
//                     ),
//                     itemCount: context.select<WeatherService, int>((value) =>
...
//                           context.watch<WeatherService>().weatherForecast;
